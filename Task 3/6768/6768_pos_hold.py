...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [1.1,0.8,9.0] #,0.01] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
		...
		self.sample_time = 0.012 # in seconds
...
if __name__ == '__main__':
	...
	rospy.sleep(5) # let everything else startup properly
